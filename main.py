...
def main():
    ...
    print("%s original MD5 hash: %s" % (fn1, d1_hash))
    print("%s original filesize: %s kB" % (fn1, round(len(d1) / 1024)))
    print("%s original MD5 hash: %s" % (fn2, d2_hash))
    ...
    print("%s collided MD5 hash: %s" % (fn1, coll_d1_hash))
    print("%s collided filesize: %s kB" % (fn1, round(len(coll_d1) / 1024)))
    print("%s collided MD5 hash: %s" % (fn2, coll_d2_hash))
